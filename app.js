...
app.put('/library/:id', upload.array('image'),authorizeAction,validateBook,csrfProtect, async(req,res,next)=>{
...
app.delete('/library/:id',authorizeAction, async(req,res)=>{
    const{id}=req.params
...
app.get('/library/:id/edit', authorizeAction,csrfProtect, async(req,res)=>{
    const{id}=req.params
    const book=await Book.findById(id)
